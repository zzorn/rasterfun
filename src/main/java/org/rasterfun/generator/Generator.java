 ...
 */
// TODO: Add possibility to pass in constants to top level expression input variables from command line.
// NOTE: Effects can be grouped together and the relevant parameters extracted to the presentation layer, this allows easily configurable generators to be created.
// TODO: Should channels depend on the generator, or the channels created/used by the effects added to it?  Maybe option to select?
